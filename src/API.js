...
exports.fetchJsonFromApi = fetchJsonFromApi;
 ...
 */
function fetchJsonFromApi(apiLink) {
    return __awaiter(this, void 0, void 0, function () {
        var token, headers, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1.default.get(apiLink, { headers: headers })];
                case 2:
                    response = _a.sent();
                    return [2 /*return*/, response.data]; // This returns the response as JSON
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching data from API:', error_1);
                    throw error_1; // Rethrow the error to handle it where the function is called
